...
?>
 <html>
  <head>
    ...
    <title>Matematicas v1</title>
     ...
     <!--Libreriía MathJax usada para establecer el formato a la escritura matematica como las fracciones, exponentes, etc. -->
    <!--<script type="text/javascrip" src="<?= base_url()?>plantilla/MathJax/MathJax.js"> </script> -->
    <script type= "text/javascript" src= "http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML" > 
    </script>

    <!--Configuración de la libreria MathJax -->
    ...
    <!-- Hacer reponsive, adaptandose al dispositivo-->
    ...
    <!-- WIRIS EDITOR: editor de ecuaciones matematicas-->
    ...
    <!-- JSXGraph: libreria para crear graficos como rectar, curvas,etc.-->
 ...
 <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg">Matemáticas</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              <li>
                <a href="#" id = 'ayuda'><i> Ayuda   |</i></a>
              </li>
              <li>
                <a href="#" id = 'registrar'><i>Registrarse |</i></a>
              </li>
              <li>
                <a href="#" id = 'acceder'><i>Iniciar Sesión |</i></a>
              </li>
              <li>
                <a href="#" data-toggle="control-sidebar" id = 'edi' ><i>Editor </i></a>
              </li>
            </ul>
          </div>
        </nav>
     ...
     <!-- Menu izquierdo en donde se encuentran las materia y los temas-->
    <aside class="main-sidebar" >
       <section class="sidebar" id='temario' ><br/><br/><br/>         
        
         <ul class="sidebar-menu">
          <li class="treeview">
            <a href="#">
              <span class="header"><i class="fa fa-book"  > A R I T M E T I C A </i></span>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li>
                <a href="#" id="multMsxMs">
                  <i class="fa fa-pencil"></i> <span>Multiplicación Algebraica</span>
                </a>
              </li>
             </span></a></li>
             ...
             <li><a href="#"><span>
              <li>
                <a href="#" id="sumaAlgebra">
                  <i class="fa fa-pencil"></i> <span>Suma y Resta Algebraica</span>
                </a>
              </li>
             </span></a></li>
             ...
             <li><a href="#"><span>
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="#" id= "divAlgebra2"><i class="fa fa-circle-o text-yellow"></i> Polinomios entre <br/>Monomio</a> </li>
                  <li><a href="#" id= "divAlgebra3"><i class="fa fa-circle-o text-yellow"></i> Polinomios entre <br/>Polinomios</a> </li>
                </ul>
              </li>
            </span></a></li>
            ...
            <li><a href="#"><span>
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-pie-chart"></i>
                  <span>Productos y Cocientes<br/> Notables</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li><a href="#" id = "pNotableCuadrado"> <i class="fa fa-circle-o text-aqua"></i>Cuadrado de la Suma <br/>y Diferencia de Dos Cantidades</a> </li>
                  <!--<li><a href="#" id= "pNotableProductoSumYRes"><i class="fa fa-circle-o text-yellow"></i>Producto de la Suma Por la<br/>Diferencia de dos Cantidades</a> </li>-->
                </ul>
              </li>
            </span></a></li>
            ...
            <li><a href="#"><span>
              <li class="treeview">
                  <a href="#">
                    <i class="fa fa-pie-chart"></i>
                    <span>Ecuaciones Simultaneas de<br/>  Primer Grado con 2 incógnitas</span>
                    <i class="fa fa-angle-left pull-right"></i>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="#" id = "metIgual"> <i class="fa fa-circle-o text-aqua"></i>Método de Igualación</a></li>
                    <li><a href="#" id= "metSust"><i class="fa fa-circle-o text-yellow"></i>Método de Sustitución</a></li>
                    <li><a href="#" id= "metReduc"><i class="fa fa-circle-o text-aqua"></i>Método de Reducción</a></li> 
                    <li><a href="#" id= "metDeter"><i class="fa fa-circle-o text-yellow"></i>Por Determinantes</a></li>
                  </ul>
              </li>
            </span></a></li>
            ...
            <li><a href="#"><span>
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-pie-chart"></i>
                  <span>Ecuaciones Simultaneas de<br/> Primer Grado con 3 incógnitas</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">  
                  <li><a href="#" id= "metUno"><i class="fa fa-circle-o text-aqua"></i>Método 1</a></li>
                  <li><a href="#" id= "metDeterTresEcu"><i class="fa fa-circle-o text-yellow"></i>Por Determinantes</a></li>
                </ul>
              </li>
            </span></a></li>
            ...
            <li><a href="#"><span>       
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-pie-chart"></i>
                  <span>Ecuaciones de Segundo <br/>con una Incógnita</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li><a href="#" id = "formGeneral"> <i class="fa fa-circle-o text-aqua"></i>Aplicando Fórmula General</a></li>
                  <li><a href="#" id= "represGrafica"><i class="fa fa-circle-o text-aqua"></i>Representación y Solución<br/> Gráfica</a></li> 
                  </ul>
              </li>  
            </span></a></li>
            ...
            <li><a href="#"><span>
              <li>
                <a href="#" id="funciones">
                  <!--<i class="fa fa-pencil"></i> <span>Funciones</span> -->
                </a>
              </li>
            </span></a></li>
    ...
    <!-- Cuerpo principal el cual cambiará a medida que segenerecodigo html dinaamico-->
    <div class="content-wrapper" id="cuerpo">
      ...
      <footer class="main-footer">
        ...
        <img src = "<?= base_url() ?>plantilla/dist/img/logo_uabjo.png"  width='3%'/><strong>Copyright &copy;</strong> Universidad Autónoma Benito Júarez de Oaxaca-Instituto Tecnológico de Oaxaca.
        <img src = "<?= base_url() ?>plantilla/dist/img/logo_ito.png"  width='3%'/>
      </footer>

	<!-- Mostrar y ocultar el editor -->
    <div class="control-sidebar control-sidebar-dark" id="editor">    </div><!-- /.control-sidebar 
    ...
    <!--Cargar los archivo .js en donde se desarrollan lo temas -->
    <script  src="<?= base_url() ?>plantilla/js/funcion1.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/funcion2.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/fracciones.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/ejemplosfraccione.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/Algebra1.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/Algebra2.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/mcm.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/mcd.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/sumaAlgebra.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/productosNotables.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/factorizacion1.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/ecuacionesLinealesDosIncog.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/ecuacionesDeSegundoGrado.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/ecuacionesLinealesTresIncog.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/usuarios.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/ejemplosPropiedade2.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/relacionesIgualdad.js"></script>
    <script  src="<?= base_url() ?>plantilla/js/divisionAlgebra.js"></script>
        <script  src="<?= base_url() ?>plantilla/js/divPoliPoli.js"></script>
